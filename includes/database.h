...
int db_add_country(const char *name, const char *capital, const char 
*language, int population, float square, const char *currency, const char 
*head);
int db_add_region(const char *name, const char *capital, int population, 
